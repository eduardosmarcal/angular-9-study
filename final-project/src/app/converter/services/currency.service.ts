...
export class CurrencyService {
  ...
  private euroCurrency: Currency[];

  private currenciesObj = [ // http://data.fixer.io/api/symbols?access_key=[YOUR_API_KEY]
  ...
  getAll(): Currency[] {
    ...
    this.currencies = this.currenciesObj.map(currencyObj => ({
      ...new Currency(),
      ...currencyObj
    }));
